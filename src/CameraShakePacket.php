...
class CameraShakePacket extends DataPacket implements ClientboundPacket{
	...
	protected function decodePayload(PacketSerializer $in) : void{
		...
		if ($out->getProtocolId() >= ProtocolInfo::PROTOCOL_1_16_210) $this->shakeAction = $in->getByte();
		else $this->shakeAction = 1;
	}
	...
	protected function encodePayload(PacketSerializer $out) : void{
		...
		if ($out->getProtocolId() >= ProtocolInfo::PROTOCOL_1_16_210) $out->putByte($this->shakeAction);
	}
