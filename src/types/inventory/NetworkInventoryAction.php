...
class NetworkInventoryAction{
	...
	public ItemStackWrapper|Item $oldItem;
	public ItemStackWrapper|Item $newItem;
	/** @var int|null */
	public $newItemStackId = null;

	public function read210(PacketSerializer $packet, bool $hasItemStackIds){
	 ...
	 * @return void
	 */
	public function write210(PacketSerializer $packet, bool $hasItemStackIds){
